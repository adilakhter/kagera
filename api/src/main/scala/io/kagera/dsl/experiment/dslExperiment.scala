...
object dslExperiment {
  ...
  case class TransformationArc[F, I <: HList, O <: HList](inputPlaces: I = HList(), transition: Transition[F], outputPlaces: O = HList()){ self ⇒
...
//    }
  ...
  implicit class PlaceProductDSL[P <: Product, L <: HList, U <: HList, C <: HList](p: P){
    ...
    def updateMarkings[O <: HList](outMarking : O)(implicit g: Generic.Aux[P, L]) = {
      (g.to(p), outMarking)
    }
